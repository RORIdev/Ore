...
object TagColor extends IntEnum[TagColor] {
  ...
  // Tag colors
  case object Nukkit            extends TagColor(1, "#0093DD", "#273238")
  case object PowerNukkit       extends TagColor(2, "#E34F4F", "#333333")
  case object CloudburstNukkit  extends TagColor(3, "#0093DD", "#273238")
  case object Unstable          extends TagColor(4, "#FFDAB9", "#333333")
